                ...
                <div class="row">
                    <div class="col-12">
                        <p class="samuraimart-product-label mt-2">
                            ...
                            <div class="star-rating" data-rate="{{ round($recommend_product->reviews->avg('score') * 2) / 2 ?? 0 }}"></div>{{ round($recommend_product->reviews->avg('score') ,1) ?? 0 }}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="samuraimart-product-label mt-2">
                                ...
                                <div class="star-rating" data-rate="{{ round($recently_product->reviews->avg('score') * 2) / 2 ?? 0 }}"></div>{{ round($recently_product->reviews->avg('score') ,1) ?? 0 }}
